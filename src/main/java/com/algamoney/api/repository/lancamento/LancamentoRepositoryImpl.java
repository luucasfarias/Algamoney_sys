...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public Page<ResumoLancamento> resumir(LancamentoFilter lancamentofilter, Pageable pageeble) {
		...
		adicionarRestricoesDePaginacao(query, pageeble);
		
		return new PageImpl<>(query.getResultList(), pageeble, total(lancamentofilter));
	}
	...
	private Predicate[] criaRestricoes(LancamentoFilter lancamentoFilter, CriteriaBuilder builder,
		...
		// se nao for vazio
		// ex: where descricao like '%textodescricao%'
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<?> query, Pageable pageable) {
		...
		int primeiroRegistroPorPagina = paginaAtual * totalRegistroPorPagina;
